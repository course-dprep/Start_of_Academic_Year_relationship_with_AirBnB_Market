...
# Create function that calculates average price in August/September and March/April and then only extracts those columns with the id column  
...
# Clean up all calendar data sets and only extract the average price in August/September and March/April and put them into a new list
clean_cal_price_datasets <- lapply(cal_datasets, clean_cal_price)

# Create function that calculates average minimum nights in August/September and March/April and then only extracts those columns with the id column  
