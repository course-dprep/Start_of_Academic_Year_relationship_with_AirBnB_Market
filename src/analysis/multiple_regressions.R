...
<<<<<<< HEAD
save(regression_price_antwerp,regression_price_amsterdam, regression_price_berlin, regression_price_brussels, regression_price_rotterdam, regression_avgnights_antwerp, regression_avgnights_amsterdam, regression_avgnights_berlin, regression_avgnights_brussels, regression_avgnights_rotterdam, file="./gen/analysis/audit/model_estimation1.RData")
...
>>>>>>> 871e93cbf5efbcd0dece71691d8b9714239ac352
